...
pub const XMODEL1_SCHEMA_NAME: &str = "xmodel1_discard_v2";
pub const XMODEL1_SCHEMA_VERSION: u32 = 2;
pub const XMODEL1_MAX_CANDIDATES: usize = 14;
pub const XMODEL1_CANDIDATE_FEATURE_DIM: usize = 35;
pub const XMODEL1_CANDIDATE_FLAG_DIM: usize = 10;
pub const XMODEL1_MAX_SPECIAL_CANDIDATES: usize = 12;
pub const XMODEL1_SPECIAL_CANDIDATE_FEATURE_DIM: usize = 25;

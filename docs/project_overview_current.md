...
最关键的验收序列现在是：
1. 先审当前 `xmodel1` 真实 cache smoke 产物
2. 对 `reach / call / none / hora` 等 slice 做 review acceptance
3. 再决定是否扩大为更广覆盖短 smoke 或第一轮短训
4. `keqingv4` 只做 focused verification 与共享 Rust ownership 推进

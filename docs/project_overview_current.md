...
- `artifacts/external_mortal_20240308_best_min.pth`: external Mortal reference and synthetic-data actor (`ext_mortal`).
...
The replay GUI supports `ext_mortal`, 70k, and the optional V2 candidate. External reviewer, NAGA, teacher-CE, and manual-audit workflows are intentionally out of scope.

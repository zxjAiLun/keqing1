...
action_scope: `{'self_turn_action_types': ('DISCARD', 'REACH_DISCARD', 'TSUMO', 'RYUKYOKU'), 'response_action_types': ('PASS', 'CHI', 'PON', 'DAIMINKAN'), 'forced_autopilot_action_types': ('TSUMO', 'RON', 'RYUKYOKU')}`
...
fresh_validation: `{'episodes': 8, 'seed_base': 202604320000, 'seed_stride': 1, 'seat_rotation': (0, 1, 2, 3), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy', 'per_iteration_early_stop_enabled': False, 'selection': 'best train+fresh gate pass; otherwise lowest fresh violation, then train/stability violation'}`
eval_seed_registry_id: `base=202604310000:stride=1:count=4`
eval_seed_hash: `b22f97dd19fd1449`
eval_scope: `fixed-seed smoke; learner seats 0,1,2,3 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.005 epochs=3 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/1/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=1394 non_top1_pos=973 actor_kept=0.995708 dropped_pos=10 kept_non_top1_pos=963 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0.00628018 weak_margin_pen=0.484229 rank_aux=0.993928 teacher_kl=0.43765 teacher_agree=0.596747 teacher_prior_agree=0.596747 teacher_rule_top1_rank=1.55296 teacher_margin=2.07925 teacher_entropy=0.556278 teacher_conf_keep=0.857654 reach_n=7 reach_policy=1 reach_teacher=0.857143 non_discard_n=468 call_n=461 agari_n=0 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.816372 scaled_prior_margin=0.83376 t_kl=0.000198044 t_clip=0 u_kl=0.00372514 u_clip=0.00965665 delta_max=0.321386 recovery_extra=0 recovery_stop=disabled eval_fourth=0.25 deal_in=0.125

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.009 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=210 non_top1_pos=135 top1_changed=0.0731707 effective_margin=0.519598 scaled_prior_margin=0.750057 t_kl=0.0167177 t_clip=0.284553 u_kl=0.0319177 u_clip=0.443089 delta_max=0.990884 eval_fourth=0.25 deal_in=0
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.0095 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=212 non_top1_pos=141 top1_changed=0.1 effective_margin=0.421928 scaled_prior_margin=0.75005 t_kl=0.00901842 t_clip=0.129167 u_kl=0.016403 u_clip=0.208333 delta_max=0.881566 eval_fourth=0.3125 deal_in=0.0625

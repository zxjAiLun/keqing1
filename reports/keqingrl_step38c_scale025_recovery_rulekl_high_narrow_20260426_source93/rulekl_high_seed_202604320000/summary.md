...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.009 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=193 non_top1_pos=123 top1_changed=0.0122449 effective_margin=0.442765 scaled_prior_margin=0.750043 t_kl=0.00299031 t_clip=0.00816326 u_kl=0.00806062 u_clip=0.138776 delta_max=0.724752 eval_fourth=0.25 deal_in=0.0625
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.0095 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=189 non_top1_pos=137 top1_changed=0 effective_margin=0.745939 scaled_prior_margin=0.750035 t_kl=0.000150297 t_clip=0 u_kl=0.00174106 u_clip=0 delta_max=0.0388797 eval_fourth=0.25 deal_in=0.0625

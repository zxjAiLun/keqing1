...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.001 epochs=1 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/1/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=1454 non_top1_pos=1024 actor_kept=0.995164 dropped_pos=12 kept_non_top1_pos=1012 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0.00424699 weak_margin_pen=0.484439 rank_aux=1.00849 teacher_kl=0.440922 teacher_agree=0.571371 teacher_prior_agree=0.571371 teacher_rule_top1_rank=1.59831 teacher_margin=2.04151 teacher_entropy=0.567563 teacher_conf_keep=0.859067 reach_n=7 reach_policy=1 reach_teacher=0.714286 non_discard_n=476 call_n=469 agari_n=0 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.834869 scaled_prior_margin=0.834436 t_kl=2.12682e-08 t_clip=0 u_kl=0.0035502 u_clip=0.0044905 delta_max=0.00257117 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-prior-topk/0.01/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=True non_top1=130 non_top1_pos=88 actor_kept=1 dropped_pos=0 kept_non_top1_pos=88 top1_changed=0.0865801 train_quality=True changed_rank=2.6 rank_ge5=0 margin_p50=3.0015 low_rank_pen=0 weak_margin_pen=0.509788 rank_aux=0.735681 teacher_kl=0.369277 teacher_agree=0.91342 teacher_prior_agree=1 teacher_rule_top1_rank=1 teacher_margin=3.00022 fresh_top1=0.0422535 fresh_quality=True qualified_eval=True effective_margin=0.66711 scaled_prior_margin=0.750055 t_kl=0.010963 t_clip=0.160173 u_kl=0.0213391 u_clip=0.333333 delta_max=1.35452 recovery_extra=0 recovery_stop=disabled eval_fourth=0.4375 deal_in=0.1875

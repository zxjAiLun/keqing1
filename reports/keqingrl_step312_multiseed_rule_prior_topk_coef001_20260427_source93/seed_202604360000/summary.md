...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-prior-topk/0.01/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=136 non_top1_pos=128 actor_kept=1 dropped_pos=0 kept_non_top1_pos=128 top1_changed=0.239382 train_quality=False changed_rank=2.53226 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.532487 rank_aux=0.818079 teacher_kl=0.451683 teacher_agree=0.760618 teacher_prior_agree=1 teacher_rule_top1_rank=1 teacher_margin=3.00025 fresh_top1=0.33617 fresh_quality=False qualified_eval=False effective_margin=0.5425 scaled_prior_margin=0.750062 t_kl=0.0121584 t_clip=0.204633 u_kl=0.0272133 u_clip=0.409266 delta_max=1.64307 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

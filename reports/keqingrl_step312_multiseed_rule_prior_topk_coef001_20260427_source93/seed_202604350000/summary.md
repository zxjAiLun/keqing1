...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-prior-topk/0.01/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=123 non_top1_pos=107 actor_kept=1 dropped_pos=0 kept_non_top1_pos=107 top1_changed=0.409091 train_quality=False changed_rank=2.44444 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.579389 rank_aux=0.915036 teacher_kl=0.548637 teacher_agree=0.590909 teacher_prior_agree=1 teacher_rule_top1_rank=1 teacher_margin=3.00025 fresh_top1=0.284444 fresh_quality=False qualified_eval=False effective_margin=0.352277 scaled_prior_margin=0.750061 t_kl=0.0117387 t_clip=0.186364 u_kl=0.0213297 u_clip=0.336364 delta_max=1.466 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.0001 epochs=1 clip=0.1 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/0.05/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=8 non_top1_pos=8 actor_kept=1 dropped_pos=0 kept_non_top1_pos=8 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.523216 rank_aux=1.03493 teacher_kl=0.268977 teacher_agree=0.545455 teacher_prior_agree=0.545455 teacher_rule_top1_rank=1.72727 teacher_margin=1.23734 teacher_entropy=0.765958 teacher_conf_keep=1 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.75014 scaled_prior_margin=0.750091 t_kl=4.20199e-10 t_clip=0 u_kl=0.00279156 u_clip=0 delta_max=0.00013099 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.005 epochs=3 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/1/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=281 non_top1_pos=272 actor_kept=0.998124 dropped_pos=1 kept_non_top1_pos=271 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0.00978979 weak_margin_pen=0.514154 rank_aux=0.927652 teacher_kl=0.519746 teacher_agree=0.663498 teacher_prior_agree=0.663498 teacher_rule_top1_rank=1.42776 teacher_margin=2.80525 teacher_entropy=0.407906 teacher_conf_keep=0.986867 reach_n=3 reach_policy=1 reach_teacher=0.666667 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.729925 scaled_prior_margin=0.738808 t_kl=0.000294831 t_clip=0 u_kl=0.00355915 u_clip=0 delta_max=0.152393 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

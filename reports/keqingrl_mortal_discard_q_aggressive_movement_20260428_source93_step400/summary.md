...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=5 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/5/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter1 pass=False non_top1=12 non_top1_pos=0 actor_kept=1 dropped_pos=0 kept_non_top1_pos=0 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.517806 rank_aux=0.959695 teacher_kl=0.508445 teacher_agree=0.555556 teacher_prior_agree=0.555556 teacher_rule_top1_rank=1.51852 teacher_margin=0.769391 teacher_entropy=0.45125 teacher_conf_keep=1 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.700037 scaled_prior_margin=0.750102 t_kl=0.0059941 t_clip=0.111111 u_kl=0.0119934 u_clip=0.148148 delta_max=0.55425 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

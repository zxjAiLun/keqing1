...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.006 epochs=3 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/10/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter7 pass=True non_top1=527 non_top1_pos=510 actor_kept=0.995847 dropped_pos=5 kept_non_top1_pos=505 top1_changed=0.0406977 train_quality=True changed_rank=2.10204 rank_ge5=0 margin_p50=3 low_rank_pen=0.00523071 weak_margin_pen=0.408963 rank_aux=0.835164 teacher_kl=0.51388 teacher_agree=0.673287 teacher_prior_agree=0.689176 teacher_rule_top1_rank=1.40119 teacher_margin=3.72981 teacher_entropy=0.321284 teacher_conf_keep=0.836379 reach_n=5 reach_policy=1 reach_teacher=0.2 non_discard_n=202 call_n=197 agari_n=0 score_changed_ep=62/64 legal_agari_rows=38 selected_agari=38 terminal_quality=True fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=1.04732 scaled_prior_margin=0.823358 t_kl=0.0125309 t_clip=0.139535 u_kl=0.0289839 u_clip=0.32392 delta_max=2.41667 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

## Contract Scoreboard

- diagnostic_only_outcome_note: `outcome counters do not gate unless --terminal-coverage-outcome-gate is enabled`
- cfg=0 teacher=mortal-action-q role=primary_action_q_teacher legal_owner_pass=True action_identity_pass=True mapping=1204/1204 opportunity_gate=True outcome_gate=False score_changed=62 selected_agari=38 qualified=True reason=qualified_for_eval notes=qualified for paired eval

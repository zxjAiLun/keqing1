...
- cfg=1 source=93 scale=0.1 temp=1.25 lr=0.01 epochs=4 clip=0.1 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/10/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=284 non_top1_pos=238 actor_kept=0.994329 dropped_pos=3 kept_non_top1_pos=235 top1_changed=0.162571 train_quality=True changed_rank=2.52326 rank_ge5=0 margin_p50=3.001 low_rank_pen=0.0063921 weak_margin_pen=0.533729 rank_aux=0.9849 teacher_kl=0.619845 teacher_agree=0.562642 teacher_prior_agree=0.621868 teacher_rule_top1_rank=1.49886 teacher_margin=3.37472 teacher_entropy=0.365055 teacher_conf_keep=0.829868 reach_n=2 reach_policy=1 reach_teacher=0.5 non_discard_n=84 call_n=82 agari_n=0 score_changed_ep=32/32 legal_agari_rows=22 selected_agari=22 terminal_quality=True fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.391825 scaled_prior_margin=0.323463 t_kl=0.0169011 t_clip=0.561437 u_kl=0.0297344 u_clip=0.667297 delta_max=1.25087 recovery_extra=0 recovery_stop=disabled eval_fourth=0.25 deal_in=0.1875
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.01 epochs=4 clip=0.1 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/10/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=279 non_top1_pos=245 actor_kept=1 dropped_pos=0 kept_non_top1_pos=245 top1_changed=0.0597015 train_quality=True changed_rank=2.44444 rank_ge5=0 margin_p50=3.0005 low_rank_pen=0 weak_margin_pen=0.455762 rank_aux=0.861028 teacher_kl=0.535359 teacher_agree=0.687251 teacher_prior_agree=0.699203 teacher_rule_top1_rank=1.38845 teacher_margin=3.74702 teacher_entropy=0.325669 teacher_conf_keep=0.832504 reach_n=0 reach_policy=0 reach_teacher=0 non_discard_n=107 call_n=107 agari_n=0 score_changed_ep=30/32 legal_agari_rows=16 selected_agari=16 terminal_quality=True fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.821102 scaled_prior_margin=0.843746 t_kl=0.0289784 t_clip=0.605307 u_kl=0.055054 u_clip=0.713101 delta_max=3.15685 recovery_extra=0 recovery_stop=disabled eval_fourth=0.125 deal_in=0.0625
...
- cfg=1 teacher=mortal-action-q role=primary_action_q_teacher legal_owner_pass=True action_identity_pass=True mapping=529/529 opportunity_gate=True outcome_gate=False score_changed=32 selected_agari=22 qualified=True reason=qualified_for_eval notes=qualified for paired eval

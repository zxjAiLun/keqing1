...
action_scope: `{'self_turn_action_types': ('DISCARD', 'REACH_DISCARD', 'TSUMO', 'RYUKYOKU'), 'response_action_types': (), 'forced_autopilot_action_types': ('TSUMO', 'RON', 'RYUKYOKU')}`
...
terminal_coverage_gate: `{'enabled': True, 'role': 'qualification_gate_for_terminal_signal_coverage', 'min_score_changed_episode_rate': 0.05, 'min_legal_agari_rows': 1, 'min_prepared_legal_agari_rows': 0, 'min_selected_agari_count': 1, 'min_selected_agari_episode_rate': 0.0, 'note': 'samples below this coverage are diagnostics only; teacher/topK strength conclusions are unqualified'}`
...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.001 epochs=1 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/1/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=282 non_top1_pos=264 actor_kept=0.996276 dropped_pos=2 kept_non_top1_pos=262 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0.0121768 weak_margin_pen=0.517385 rank_aux=0.93174 teacher_kl=0.524016 teacher_agree=0.661017 teacher_prior_agree=0.661017 teacher_rule_top1_rank=1.43503 teacher_margin=2.83354 teacher_entropy=0.407725 teacher_conf_keep=0.988827 reach_n=5 reach_policy=1 reach_teacher=0.6 non_discard_n=5 call_n=0 agari_n=0 score_changed_ep=32/32 legal_agari_rows=9 selected_agari=9 terminal_quality=True fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.741597 scaled_prior_margin=0.739364 t_kl=2.14442e-08 t_clip=0 u_kl=0.00278018 u_clip=0 delta_max=0.00248817 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=176 non_top1_pos=139 top1_changed=0.138889 effective_margin=0.419736 scaled_prior_margin=0.750039 t_kl=0.0109624 t_clip=0.199074 u_kl=0.0210535 u_clip=0.300926 delta_max=1.35986 recovery_extra=0 recovery_stop=not_needed eval_fourth=0.4375 deal_in=0.125

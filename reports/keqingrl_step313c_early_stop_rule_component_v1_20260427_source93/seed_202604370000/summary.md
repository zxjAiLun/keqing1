...
fresh_validation: `{'episodes': 16, 'seed_base': 202604390000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy', 'per_iteration_early_stop_enabled': True, 'selection': 'best train+fresh gate pass; otherwise lowest fresh violation, then train/stability violation'}`
...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/1/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 early_stop=True/iter1 pass=True non_top1=134 non_top1_pos=103 actor_kept=1 dropped_pos=0 kept_non_top1_pos=103 top1_changed=0.05 train_quality=True changed_rank=2.41667 rank_ge5=0 margin_p50=3.0005 low_rank_pen=0 weak_margin_pen=0.534393 rank_aux=1.05234 teacher_kl=0.102905 teacher_agree=0.670833 teacher_prior_agree=0.691667 teacher_rule_top1_rank=1.3875 teacher_margin=0.459107 teacher_entropy=1.02971 teacher_conf_keep=0.25 fresh_top1=0.0152284 fresh_quality=True qualified_eval=True effective_margin=0.552932 scaled_prior_margin=0.750054 t_kl=0.0158144 t_clip=0.2375 u_kl=0.0256457 u_clip=0.333333 delta_max=0.931166 recovery_extra=0 recovery_stop=disabled eval_fourth=0.25 deal_in=0.0625

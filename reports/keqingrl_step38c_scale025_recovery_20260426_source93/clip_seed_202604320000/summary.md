...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0 delta_clip=1/0.001 pass=False non_top1=193 non_top1_pos=123 top1_changed=0.00816326 effective_margin=0.445108 scaled_prior_margin=0.750043 t_kl=0.00287593 t_clip=0.00816326 u_kl=0.00782882 u_clip=0.130612 delta_max=0.825898 eval_fourth=0.25 deal_in=0.0625
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.01 delta_l2=0 delta_clip=1/0.001 pass=False non_top1=189 non_top1_pos=137 top1_changed=0 effective_margin=0.745958 scaled_prior_margin=0.750035 t_kl=0.000150211 t_clip=0 u_kl=0.00174038 u_clip=0 delta_max=0.0261229 eval_fourth=0.25 deal_in=0.0625

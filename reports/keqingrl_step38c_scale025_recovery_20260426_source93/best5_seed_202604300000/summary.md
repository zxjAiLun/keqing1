...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=189 non_top1_pos=115 top1_changed=0 effective_margin=0.695653 scaled_prior_margin=0.750045 t_kl=0.000259997 t_clip=0 u_kl=0.00183931 u_clip=0 delta_max=0.115364 eval_fourth=0.375 deal_in=0.125

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=167 non_top1_pos=112 top1_changed=0.005 effective_margin=0.525831 scaled_prior_margin=0.75005 t_kl=0.00601052 t_clip=0.05 u_kl=0.00611751 u_clip=0.09 delta_max=0.639669 eval_fourth=0.375 deal_in=0.125

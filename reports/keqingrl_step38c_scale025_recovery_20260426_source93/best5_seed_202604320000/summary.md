...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=205 non_top1_pos=171 top1_changed=0.473029 effective_margin=0.204465 scaled_prior_margin=0.750046 t_kl=0.0109214 t_clip=0.186722 u_kl=0.0224028 u_clip=0.360996 delta_max=1.57008 eval_fourth=0.4375 deal_in=0.1875

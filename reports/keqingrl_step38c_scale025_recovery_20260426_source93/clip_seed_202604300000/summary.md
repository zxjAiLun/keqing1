...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0 delta_clip=1/0.001 pass=False non_top1=171 non_top1_pos=76 top1_changed=0 effective_margin=0.720149 scaled_prior_margin=0.750025 t_kl=0.000888637 t_clip=0 u_kl=0.00255756 u_clip=0.0152284 delta_max=0.150024 eval_fourth=0.375 deal_in=0.125
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.01 delta_l2=0 delta_clip=1/0.001 pass=True non_top1=193 non_top1_pos=99 top1_changed=0.142222 effective_margin=0.39169 scaled_prior_margin=0.750047 t_kl=0.0043704 t_clip=0.0533333 u_kl=0.00971959 u_clip=0.155556 delta_max=0.644013 eval_fourth=0.375 deal_in=0.125

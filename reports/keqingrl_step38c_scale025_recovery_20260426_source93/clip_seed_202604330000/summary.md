...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0 delta_clip=1/0.001 pass=False non_top1=210 non_top1_pos=134 top1_changed=0.0772358 effective_margin=0.507486 scaled_prior_margin=0.750057 t_kl=0.019332 t_clip=0.325203 u_kl=0.0363037 u_clip=0.48374 delta_max=1.16846 eval_fourth=0.3125 deal_in=0
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.01 delta_l2=0 delta_clip=1/0.001 pass=True non_top1=212 non_top1_pos=141 top1_changed=0.1 effective_margin=0.42184 scaled_prior_margin=0.75005 t_kl=0.00917306 t_clip=0.129167 u_kl=0.0166723 u_clip=0.204167 delta_max=0.881143 eval_fourth=0.3125 deal_in=0.0625

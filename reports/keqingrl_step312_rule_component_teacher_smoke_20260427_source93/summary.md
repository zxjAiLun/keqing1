...
fresh_validation: `{'episodes': 1, 'seed_base': 202604920000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy'}`
eval_seed_registry_id: `base=202604910000:stride=1:count=2`
eval_seed_hash: `444869d6e5ec98ca`
eval_scope: `fixed-seed smoke; learner seat 0 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=1 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.01/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=13 non_top1_pos=8 actor_kept=1 dropped_pos=0 kept_non_top1_pos=8 top1_changed=0 train_quality=False changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.522982 rank_aux=1.08565 teacher_kl=0.0617749 teacher_agree=0.666667 teacher_prior_agree=0.666667 teacher_rule_top1_rank=1.44444 teacher_margin=0.548545 fresh_top1=0 fresh_quality=False qualified_eval=False effective_margin=0.750631 scaled_prior_margin=0.750093 t_kl=7.75609e-07 t_clip=0 u_kl=0.00286493 u_clip=0 delta_max=0.00623835 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

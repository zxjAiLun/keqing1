...
fresh_validation: `{'episodes': 1, 'seed_base': 202604520000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy'}`
eval_seed_registry_id: `base=202604510000:stride=1:count=2`
eval_seed_hash: `d5440c007ad361f8`
eval_scope: `fixed-seed smoke; learner seat 0 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=1 clip=0.2 rule_kl=0.001 delta_l2=0.001 delta_clip=0/0 low_rank=3/0 weak_margin=0.75/0 actor_support=topk/3/0.75 pass=False non_top1=18 non_top1_pos=6 actor_kept=0.333333 dropped_pos=3 kept_non_top1_pos=3 top1_changed=0 train_quality=False changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=3.7793 weak_margin_pen=0.862824 fresh_top1=0 fresh_quality=False qualified_eval=False effective_margin=0.748074 scaled_prior_margin=0.75 t_kl=3.77987e-06 t_clip=0 u_kl=0.00131372 u_clip=0 delta_max=0.0139741 recovery_extra=1 recovery_stop=budget_exhausted eval_fourth=nan deal_in=nan

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.005 epochs=3 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-action-q/1/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter0 pass=False non_top1=281 non_top1_pos=249 actor_kept=1 dropped_pos=0 kept_non_top1_pos=249 top1_changed=0 train_quality=True changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.494288 rank_aux=0.960182 teacher_kl=0.521271 teacher_agree=0.627723 teacher_prior_agree=0.627723 teacher_rule_top1_rank=1.48317 teacher_margin=2.6341 teacher_entropy=0.438911 teacher_conf_keep=0.945693 reach_n=6 reach_policy=1 reach_teacher=0.666667 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.696883 scaled_prior_margin=0.706543 t_kl=0.000159932 t_clip=0 u_kl=0.00310633 u_clip=0 delta_max=0.158903 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

...
fresh_validation: `{'episodes': 16, 'seed_base': 202604730000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy'}`
eval_seed_registry_id: `base=202604720000:stride=1:count=16`
eval_seed_hash: `b73794112ee581b9`
eval_scope: `fixed-seed smoke; learner seat 0 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.002 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=124 non_top1_pos=109 actor_kept=1 dropped_pos=0 kept_non_top1_pos=109 top1_changed=0.15814 train_quality=False changed_rank=2.58824 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.53251 fresh_top1=0.188073 fresh_quality=False qualified_eval=False effective_margin=0.562736 scaled_prior_margin=0.750062 t_kl=0.00838966 t_clip=0.134884 u_kl=0.0169028 u_clip=0.246512 delta_max=1.7732 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

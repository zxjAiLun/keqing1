...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.0075 delta_l2=0.0005 delta_clip=0/0 pass=False non_top1=193 non_top1_pos=123 top1_changed=0.00816326 effective_margin=0.444243 scaled_prior_margin=0.750043 t_kl=0.00289374 t_clip=0.00816326 u_kl=0.007877 u_clip=0.134694 delta_max=0.758956 eval_fourth=0.25 deal_in=0.0625
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.0075 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=189 non_top1_pos=137 top1_changed=0 effective_margin=0.745893 scaled_prior_margin=0.750035 t_kl=0.000149601 t_clip=0 u_kl=0.00174004 u_clip=0 delta_max=0.0395896 eval_fourth=0.25 deal_in=0.0625

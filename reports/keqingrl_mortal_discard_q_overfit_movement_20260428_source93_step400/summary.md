...
entropy_coef: `0.0`
pass_criteria: `{'min_top1_changed': 999.0, 'max_top1_changed': 0.25, 'max_tempered_kl': 0.03, 'max_tempered_clip': 0.3, 'max_untempered_clip': 0.8, 'max_eval_fourth': 0.5, 'max_eval_deal_in': 0.25}`
adaptive_recovery: `{'enabled': False, 'role': 'adaptive_movement_diagnostic_not_candidate_selector', 'max_extra_epochs': 0, 'min_top1_changed': 999.0, 'max_top1_changed': 0.25, 'max_tempered_kl': 0.03, 'max_tempered_clip': 0.3, 'max_untempered_clip': 0.8, 'rollback_on_unstable_overmove_or_quality': True}`
...
movement_quality_gate: `{'enabled': False, 'role': 'candidate_selector', 'train_min_top1_changed': 999.0, 'train_max_top1_changed': 0.15, 'max_changed_prior_rank_mean': 3.0, 'max_rank_ge5_rate': 0.1, 'max_prior_margin_p50': 1.0}`
...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.005 epochs=10 clip=0.3 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/10/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter2 pass=False non_top1=17 non_top1_pos=17 actor_kept=1 dropped_pos=0 kept_non_top1_pos=17 top1_changed=0.25 train_quality=True changed_rank=2.22222 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.54005 rank_aux=0.723123 teacher_kl=0.59207 teacher_agree=0.722222 teacher_prior_agree=0.638889 teacher_rule_top1_rank=1.41667 teacher_margin=1.09817 teacher_entropy=0.131053 teacher_conf_keep=1 fresh_top1=0 fresh_quality=True qualified_eval=True effective_margin=0.601034 scaled_prior_margin=0.750056 t_kl=0.22449 t_clip=0.527778 u_kl=0.360458 u_clip=0.555556 delta_max=4.62981 recovery_extra=0 recovery_stop=disabled eval_fourth=0 deal_in=0

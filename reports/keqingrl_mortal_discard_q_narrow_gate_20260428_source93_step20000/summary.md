...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.0023 epochs=5 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/5/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter1 pass=False non_top1=48 non_top1_pos=48 actor_kept=1 dropped_pos=0 kept_non_top1_pos=48 top1_changed=0 train_quality=False changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.523275 rank_aux=0.939622 teacher_kl=0.882235 teacher_agree=0.583333 teacher_prior_agree=0.583333 teacher_rule_top1_rank=1.5 teacher_margin=2.58029 teacher_entropy=0.0573865 teacher_conf_keep=1 fresh_top1=0 fresh_quality=True qualified_eval=False effective_margin=0.647577 scaled_prior_margin=0.750028 t_kl=0.00361155 t_clip=0.0277778 u_kl=0.00834535 u_clip=0.152778 delta_max=0.62147 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.0025 epochs=5 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/5/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter1 pass=False non_top1=20 non_top1_pos=6 actor_kept=1 dropped_pos=0 kept_non_top1_pos=6 top1_changed=0.0952381 train_quality=False changed_rank=2.75 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.509386 rank_aux=0.786783 teacher_kl=0.75826 teacher_agree=0.714286 teacher_prior_agree=0.738095 teacher_rule_top1_rank=1.33333 teacher_margin=2.79675 teacher_entropy=0.0285231 teacher_conf_keep=1 fresh_top1=0.354839 fresh_quality=False qualified_eval=False effective_margin=0.641659 scaled_prior_margin=0.750048 t_kl=0.0314944 t_clip=0.380952 u_kl=0.0546586 u_clip=0.5 delta_max=1.1773 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan
- cfg=2 source=93 scale=0.25 temp=1.25 lr=0.0027 epochs=5 clip=0.2 rule_kl=0 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/mortal-discard-q/5/k3 teacher_conf=False/1e+09/0 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=topk/3/0.75 early_stop=False/iter1 pass=False non_top1=33 non_top1_pos=0 actor_kept=1 dropped_pos=0 kept_non_top1_pos=0 top1_changed=0 train_quality=False changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=0 weak_margin_pen=0.521189 rank_aux=0.912591 teacher_kl=0.86772 teacher_agree=0.650794 teacher_prior_agree=0.650794 teacher_rule_top1_rank=1.39683 teacher_margin=3.26272 teacher_entropy=0.0448705 teacher_conf_keep=1 fresh_top1=0 fresh_quality=True qualified_eval=False effective_margin=0.745851 scaled_prior_margin=0.750079 t_kl=0.00035303 t_clip=0 u_kl=0.0036063 u_clip=0 delta_max=0.136848 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

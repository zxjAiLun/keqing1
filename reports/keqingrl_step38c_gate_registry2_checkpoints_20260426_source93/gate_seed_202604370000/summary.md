...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=213 non_top1_pos=190 top1_changed=0.122047 effective_margin=0.434901 scaled_prior_margin=0.750059 t_kl=0.00958907 t_clip=0.137795 u_kl=0.0174483 u_clip=0.248031 delta_max=0.934528 recovery_extra=0 recovery_stop=not_needed eval_fourth=0.375 deal_in=0.125

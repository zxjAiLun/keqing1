...
eval_seed_registry_id: `base=202604340000:stride=1:count=16`
eval_seed_hash: `a6950a991a86e1d9`
eval_scope: `fixed-seed smoke; learner seat 0 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=212 non_top1_pos=183 top1_changed=0.236948 effective_margin=0.387612 scaled_prior_margin=0.75005 t_kl=0.0116571 t_clip=0.156627 u_kl=0.0243563 u_clip=0.373494 delta_max=1.01719 recovery_extra=0 recovery_stop=not_needed eval_fourth=0.4375 deal_in=0.125

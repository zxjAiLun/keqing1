...
- cfg=0 teacher=mortal-action-q role=primary_action_q_teacher legal_owner_pass=True action_identity_pass=True mapping=0/1 missing=2 extra=0 fail_closed=1 opportunity_gate=False legal_agari_rows=0 selected_agari=0 qualified=False reason=blocked_by_mask_parity_gap notes=blocked by mask parity gap|unqualified opportunity coverage

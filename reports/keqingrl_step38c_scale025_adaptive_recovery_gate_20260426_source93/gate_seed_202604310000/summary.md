...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=206 non_top1_pos=163 top1_changed=0.161157 effective_margin=0.386257 scaled_prior_margin=0.750036 t_kl=1.07462e-14 t_clip=0 u_kl=0.0020296 u_clip=0 delta_max=0.995086 recovery_extra=0 recovery_stop=base_rejected_unstable_or_overmove eval_fourth=0.4375 deal_in=0.0625

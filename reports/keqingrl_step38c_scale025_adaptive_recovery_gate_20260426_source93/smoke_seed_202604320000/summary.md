...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=False non_top1=216 non_top1_pos=140 top1_changed=0.276 effective_margin=0.233164 scaled_prior_margin=0.750031 t_kl=0.0126002 t_clip=0.228 u_kl=0.0183456 u_clip=0.324 delta_max=0.878991 recovery_extra=0 recovery_stop=not_needed eval_fourth=0.3125 deal_in=0.125

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.001 delta_clip=0/0 pass=True non_top1=205 non_top1_pos=155 top1_changed=0.0322581 effective_margin=0.473184 scaled_prior_margin=0.750043 t_kl=0.0126778 t_clip=0.189516 u_kl=0.0109277 u_clip=0.197581 delta_max=0.563261 recovery_extra=0 recovery_stop=not_needed eval_fourth=0.3125 deal_in=0

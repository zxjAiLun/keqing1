...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=139 non_top1_pos=132 actor_kept=1 dropped_pos=0 kept_non_top1_pos=132 top1_changed=0.252918 train_quality=False changed_rank=2.70769 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.539989 rank_aux=1.1826 teacher_kl=0.151791 teacher_agree=0.505837 teacher_prior_agree=0.657588 teacher_rule_top1_rank=1.44747 teacher_margin=0.44376 fresh_top1=0.212389 fresh_quality=False qualified_eval=False effective_margin=0.535875 scaled_prior_margin=0.75006 t_kl=0.011785 t_clip=0.151751 u_kl=0.0264094 u_clip=0.342412 delta_max=1.2436 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=True non_top1=130 non_top1_pos=89 actor_kept=1 dropped_pos=0 kept_non_top1_pos=89 top1_changed=0.134199 train_quality=True changed_rank=2.58065 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.512179 rank_aux=1.14643 teacher_kl=0.118081 teacher_agree=0.636364 teacher_prior_agree=0.705628 teacher_rule_top1_rank=1.38961 teacher_margin=0.479793 fresh_top1=0.0619048 fresh_quality=True qualified_eval=True effective_margin=0.650749 scaled_prior_margin=0.750055 t_kl=0.0143596 t_clip=0.233766 u_kl=0.0287167 u_clip=0.445887 delta_max=1.32891 recovery_extra=0 recovery_stop=disabled eval_fourth=0.4375 deal_in=0.125

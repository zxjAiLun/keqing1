...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=113 non_top1_pos=102 actor_kept=1 dropped_pos=0 kept_non_top1_pos=102 top1_changed=0.396396 train_quality=False changed_rank=2.54545 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.57426 rank_aux=1.20728 teacher_kl=0.177759 teacher_agree=0.427928 teacher_prior_agree=0.617117 teacher_rule_top1_rank=1.44595 teacher_margin=0.450676 fresh_top1=0.316742 fresh_quality=False qualified_eval=False effective_margin=0.388656 scaled_prior_margin=0.750058 t_kl=0.0130118 t_clip=0.216216 u_kl=0.0239238 u_clip=0.351351 delta_max=1.74896 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

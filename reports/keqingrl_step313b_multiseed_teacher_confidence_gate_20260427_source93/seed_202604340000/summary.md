...
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/1/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=109 non_top1_pos=92 actor_kept=1 dropped_pos=0 kept_non_top1_pos=92 top1_changed=0.278302 train_quality=False changed_rank=2.49153 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.553753 rank_aux=1.06847 teacher_kl=0.116976 teacher_agree=0.566038 teacher_prior_agree=0.716981 teacher_rule_top1_rank=1.34434 teacher_margin=0.512348 teacher_entropy=1.01965 teacher_conf_keep=0.334906 fresh_top1=0.280543 fresh_quality=False qualified_eval=False effective_margin=0.517112 scaled_prior_margin=0.750038 t_kl=0.0179004 t_clip=0.278302 u_kl=0.0254536 u_clip=0.358491 delta_max=3.13418 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

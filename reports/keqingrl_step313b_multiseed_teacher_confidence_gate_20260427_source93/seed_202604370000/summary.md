...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/0.8/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=True non_top1=126 non_top1_pos=118 actor_kept=1 dropped_pos=0 kept_non_top1_pos=118 top1_changed=0.128 train_quality=True changed_rank=2.46875 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.519685 rank_aux=0.772849 teacher_kl=0.00175632 teacher_agree=0.66 teacher_prior_agree=0.724 teacher_rule_top1_rank=1.324 teacher_margin=0.544257 teacher_entropy=1.01714 teacher_conf_keep=0.004 fresh_top1=0.0812183 fresh_quality=True qualified_eval=True effective_margin=0.612309 scaled_prior_margin=0.750053 t_kl=0.0159289 t_clip=0.248 u_kl=0.0304751 u_clip=0.416 delta_max=1.17218 recovery_extra=0 recovery_stop=disabled eval_fourth=0.3125 deal_in=0.125
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/1/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=True non_top1=137 non_top1_pos=116 actor_kept=1 dropped_pos=0 kept_non_top1_pos=116 top1_changed=0.090535 train_quality=True changed_rank=2.45455 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.526993 rank_aux=1.05076 teacher_kl=0.108486 teacher_agree=0.559671 teacher_prior_agree=0.596708 teacher_rule_top1_rank=1.54321 teacher_margin=0.472281 teacher_entropy=1.02457 teacher_conf_keep=0.271605 fresh_top1=0.0341463 fresh_quality=True qualified_eval=True effective_margin=0.605776 scaled_prior_margin=0.750053 t_kl=0.00930343 t_clip=0.131687 u_kl=0.020521 u_clip=0.292181 delta_max=1.92634 recovery_extra=0 recovery_stop=disabled eval_fourth=0.25 deal_in=0.0625

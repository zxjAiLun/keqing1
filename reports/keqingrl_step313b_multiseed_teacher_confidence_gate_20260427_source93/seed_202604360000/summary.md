...
fresh_validation: `{'episodes': 16, 'seed_base': 202604380000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy'}`
...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/0.8/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=141 non_top1_pos=133 actor_kept=1 dropped_pos=0 kept_non_top1_pos=133 top1_changed=0.223938 train_quality=False changed_rank=2.55172 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.544356 rank_aux=0.876612 teacher_kl=0.11981 teacher_agree=0.50193 teacher_prior_agree=0.656371 teacher_rule_top1_rank=1.45174 teacher_margin=0.478944 teacher_entropy=1.02674 teacher_conf_keep=0.003861 fresh_top1=0.252137 fresh_quality=False qualified_eval=False effective_margin=0.515043 scaled_prior_margin=0.750071 t_kl=0.01276 t_clip=0.212355 u_kl=0.0237379 u_clip=0.335907 delta_max=1.64167 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=8 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 ranking_aux=teacher-ce/rule-component-v1/0.03/k3 teacher_conf=True/1/0.2 low_rank=3/0 weak_margin=0.75/0 support_policy=support-only-topk delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=117 non_top1_pos=105 actor_kept=1 dropped_pos=0 kept_non_top1_pos=105 top1_changed=0.223176 train_quality=False changed_rank=2.53846 rank_ge5=0 margin_p50=3.001 low_rank_pen=0 weak_margin_pen=0.533646 rank_aux=1.04625 teacher_kl=0.114097 teacher_agree=0.592275 teacher_prior_agree=0.725322 teacher_rule_top1_rank=1.37768 teacher_margin=0.474034 teacher_entropy=1.02405 teacher_conf_keep=0.236051 fresh_top1=0.06 fresh_quality=True qualified_eval=False effective_margin=0.598753 scaled_prior_margin=0.750062 t_kl=0.0149576 t_clip=0.227468 u_kl=0.0311296 u_clip=0.381974 delta_max=1.34556 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

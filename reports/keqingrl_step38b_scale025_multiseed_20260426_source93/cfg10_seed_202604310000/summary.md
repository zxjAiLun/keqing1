...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.001 pass=True non_top1=172 non_top1_pos=111 top1_changed=0.168182 effective_margin=0.366977 scaled_prior_margin=0.75005 t_kl=0.00524628 t_clip=0.05 u_kl=0.0127814 u_clip=0.168182 delta_max=0.93637 eval_fourth=0.375 deal_in=0.0625

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.0003 delta_clip=0/0 pass=False non_top1=171 non_top1_pos=76 top1_changed=0 effective_margin=0.720312 scaled_prior_margin=0.750025 t_kl=0.000887389 t_clip=0 u_kl=0.00255497 u_clip=0.0152284 delta_max=0.108275 eval_fourth=0.375 deal_in=0.125
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.0005 delta_clip=0/0 pass=True non_top1=193 non_top1_pos=99 top1_changed=0.151111 effective_margin=0.386309 scaled_prior_margin=0.750047 t_kl=0.00448469 t_clip=0.0577778 u_kl=0.00996881 u_clip=0.16 delta_max=0.602804 eval_fourth=0.375 deal_in=0.125

...
- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.0003 delta_clip=0/0 pass=True non_top1=172 non_top1_pos=112 top1_changed=0.168182 effective_margin=0.365631 scaled_prior_margin=0.75005 t_kl=0.00523342 t_clip=0.0590909 u_kl=0.0127474 u_clip=0.172727 delta_max=1.0653 eval_fourth=0.375 deal_in=0.0625
- cfg=1 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=4 clip=0.2 rule_kl=0.005 delta_l2=0.0005 delta_clip=0/0 pass=True non_top1=187 non_top1_pos=107 top1_changed=0.159817 effective_margin=0.392745 scaled_prior_margin=0.750042 t_kl=0.00900362 t_clip=0.114155 u_kl=0.0179833 u_clip=0.319635 delta_max=0.956718 eval_fourth=0.375 deal_in=0.125

...
fresh_validation: `{'episodes': 1, 'seed_base': 202604580000, 'seed_stride': 1, 'seat_rotation': (0,), 'min_top1_changed': 0.01, 'max_top1_changed': 0.1, 'policy_mode': 'greedy'}`
eval_seed_registry_id: `base=202604570000:stride=1:count=2`
eval_seed_hash: `86e912ed70d7ddf1`
eval_scope: `fixed-seed smoke; learner seat 0 only`
eval_strength_note: `sanity check only; not duplicate strength evidence`

## Results

- cfg=0 source=93 scale=0.25 temp=1.25 lr=0.003 epochs=1 clip=0.2 rule_kl=0.001 delta_l2=0 delta_clip=0/0 low_rank=3/0 weak_margin=0.75/0 delta_support=topk/3/0.75/zero actor_support=all/3/0.75 pass=False non_top1=23 non_top1_pos=0 actor_kept=1 dropped_pos=0 kept_non_top1_pos=0 top1_changed=0 train_quality=False changed_rank=0 rank_ge5=0 margin_p50=0 low_rank_pen=3.17547 weak_margin_pen=0.849254 fresh_top1=0 fresh_quality=False qualified_eval=False effective_margin=0.733652 scaled_prior_margin=0.750094 t_kl=1.53855e-05 t_clip=0 u_kl=0.000447385 u_clip=0 delta_max=0.0262539 recovery_extra=0 recovery_stop=disabled eval_fourth=nan deal_in=nan

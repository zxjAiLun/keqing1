...
This module provides the stable, model-agnostic evaluation core for Xmodel1's
case benchmark harness. Model-specific inference can later be layered on top of
these helpers.
"""
...
def main() -> None:
    ...
    print(f"Xmodel1 eval runner ready: {base}")
    print("This module currently exposes case loading and preferred/acceptable/bad/blunder aggregation.")

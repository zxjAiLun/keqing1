...
from scripts.mortal.audit_d3_exploration_production_2026_08 import (
    DecisionSnapshot,
    audit_event_records,
    primary_row_flags,
)
from scripts.mortal.d3_exploration_engine import canonical_hash_u
from scripts.mortal.run_d3_exploration_production_2026_08 import (

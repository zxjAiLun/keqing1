...
from scripts.mortal.d3_exploration_engine import (
    CONTRACT_ID, EXPLORATION_PROBABILITY, HANCHAN_BUDGET, KYOKU_BUDGET, MARGIN_THRESHOLD,
)
from scripts.mortal.d3_production_contract import (
    AUDIT_SCHEMA, DEFAULT_OUTPUT_DIR, GAMES, GATE_ID, RANK_POINTS, REQUIRED_LABELS, read_json, write_json,
)
from scripts.mortal.d3_production_audit_core import (
    DecisionSnapshot, _load_events, _load_log_manifest, primary_row_flags,
)
from scripts.mortal.d3_production_event_audit import audit_event_records
from scripts.mortal.d3_production_lineage_audit import _current_lineage_checks, _protocol_checks
from scripts.mortal.d3_production_replay_audit import _build_decision_snapshots
from scripts.mortal.d3_production_report import _exploration_distribution, _write_markdown
...
def audit(args: argparse.Namespace) -> dict[str, Any]:
    ...
    from scripts.mortal.stat_report import write_stat_report  # noqa: PLC0415

...
from scripts.mortal.d3_exploration_engine import CONTRACT_ID, D3ExplorationEngine
...
from scripts.mortal.d3_production_preflight import build_preflight, final_call_guard
...
def _execute(args: argparse.Namespace, preflight: dict[str, Any]) -> dict[str, Any]:
    ...
    from scripts.mortal.four_player_native import _load_engine  # noqa: PLC0415

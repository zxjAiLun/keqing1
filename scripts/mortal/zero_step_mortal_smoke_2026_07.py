...
def main() -> None:
    ...
    from scripts.mortal.mainline_dataloader import FileDatasetsIter  # noqa: PLC0415
    from scripts.mortal.objective import compute_objective_losses, objective_contract_from_config  # noqa: PLC0415

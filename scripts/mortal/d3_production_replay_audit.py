...
from scripts.mortal.d3_exploration_engine import DISCARD_ACTION_LIMIT, MARGIN_THRESHOLD
from scripts.mortal.d3_production_contract import DEVICE, GAMES, RANK_POINTS
...
def _build_decision_snapshots(
    *,
    ...
    from scripts.mortal.audit_replay_distribution import (  # noqa: PLC0415
        action_name,
        load_checkpoint,
        load_model,
        model_q,

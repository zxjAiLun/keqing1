...
def _summary_markdown(args: argparse.Namespace, reports: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "Metric fidelity note: illegal/fallback/forced-terminal counters are fail-closed hard raise gates, not observed recoverable event rates.",
        ...
        f"- fixed_seed_eval: games={fixed.episode_count}, passed={fixed.passed_smoke_checks}, avg_rank={fixed.average_rank:.6g}, rank_pt={fixed.rank_pt:.6g}, fourth_rate={fixed.fourth_rate:.6g}, learner_deal_in_rate={fixed.learner_deal_in_rate:.6g}",

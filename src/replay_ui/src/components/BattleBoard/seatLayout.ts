...
// 视觉合同：south 满手牌第一张从设计坐标 x=SELF_HAND_ORIGIN_X_PX 开始。
// shell 右边缘保持 1240（right margin 40）不动，因此 shell 宽度由真实牌桌坐标推导，
// 而不是手写一个魔法数：shell 左边缘 = meldRight − shellWidth = 160。

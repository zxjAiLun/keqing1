// src/replay_ui/scripts/checkLadderIngestSemantics.ts
...
const ingest = read('src/replay/ladder_ingest.py');
...
const publisher = read('scripts/mortal/publish_ladder_snapshot.py');
